...
function FlashSale(props) {
  ...
  const pickBook = books.map(book =>  <SwiperSlide className='flash-sale-slide'>
  ...
  return (
    <React.Fragment>
      <div className='flash-sale w-[100%] flex justify-between items-center bg-[#5b067d] h-[60vh] mt-10 relative'>
        <div className='purple-noise absolute w-[300px] h-[400px] rounded-[100%] right-[-9%]'></div>
        <div className='purple-noise absolute w-[200px] h-[400px] rounded-[100%] left-[30%]'></div>
