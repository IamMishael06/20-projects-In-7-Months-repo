...
function SecondNav({ isOpen }) {
  return (
   <>
       <div className={`navbar ${isOpen ? 'open' : ''} absolute  w-[100%] bg-[#8a2aaa] overflow-hidden py-[20px] flex items-center justify-center transition-[2.4s] md:flex-none md:relative md:py-0`}>
